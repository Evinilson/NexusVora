...
<head>
  ...
  <meta name="description" content="Conheça a NexusVora — a agência de marketing digital full-service que transforma empresas em marcas que vendem, com estratégia, criatividade e resultados mensuráveis.">
...
<script>
  ...
  window.addEventListener('scroll', () => {
    ...
    if (nav) nav.style.background = window.scrollY > 50 ? 'rgba(6,11,32,0.97)' : 'rgba(10,15,46,0.85)';
  });
</script>
